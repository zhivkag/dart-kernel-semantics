...
For the EvalConfiguration the transition step dispatches on the expression component, $\expr$.
...
For the EvalList configuration the transition step dispatches on the expression list, $\exprs$.
...
For the ExecConfiguration the transition step dispatches on the statement expression, $\stmt$.
...
For the ThrowConfiguration the transition step dispatches its continuation component.
...
For the BreakConfiguration the transition step dispatches on the continuation component.
...
For the SwitchConfiguration the transition step dispatches on the continuation component.
...
Transitions of the CESK machine for basic literals are presented in rows 1 - 5 in Table~\ref{table:evalconfigs}.
