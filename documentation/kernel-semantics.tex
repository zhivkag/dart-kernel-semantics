...
%
\makeatletter
\renewcommand{\p@rowcount}{\thesubsection.\thetablecount.}
\makeatother
%
...
\begin{center}
  ...
  \end{array}
  $
  \captionof{table}{Expression Continuations}
\end{center}
...
\begin{center}
  ...
  \end{array}
  $
  \captionof{table}{Statement Continuations}
\end{center}
...
\begin{center}
  ...
  \end{array}
  $
  \captionof{table}{Application Continuations}
\end{center}
...
\begin{center}
  ...
  \end{array}
  $
  \captionof{table}{Break Continuations}
\end{center}
...
\begin{center}
  ...
  \end{array}
  $
  \captionof{table}{Switch Continuations}
\end{center}
%
\noindent
...
\begin{center}
  ...
  \end{array}
  $
  \captionof{table}{Exception handlers}
\end{center}
\subsection{Values}
\label{subsec:values}
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{Expressions}
	\label{table:expressions-evalconfigs}
\end{center}
%
\stepcounter{tablecount}
%
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{Static variable extraction and assignment, and static method invocation}
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{The CESK-transition function for instance property extraction and assignment expressions}
	\label{table:instance-property-evalconfigs}
\end{center}
%
\stepcounter{tablecount}
%
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{Instance method and constructor invocation}
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{The CESK-transition function for statements}
	\label{table:instance-method-evalconfigs}
\end{center}
