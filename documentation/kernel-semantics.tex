...
\subsection{Audience}
This paper is targeted toward compiler and framework authors and academics.
...
The abstract syntax of \kernel{} is slightly unusual in that it does not correspond to a concrete, textual syntax.
