...
%
% Typesets a transiton from configuration FROM to configuration TO. Like this:
%
%     FROM => TO
%
% "Align" variant has an embedded "&" inside, immideately before the transition
...
% environment hat aligns its multi-line content using "&" signs, for example
