...
%
\newcommand{\evalcesktrans}[4]{\labl{#1}\, &\cesktrans{#2}{#3}\,\hspace{2mm}#4\\[2mm]}
%
%% Continuations
%
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{Evaluation of simple expressions}
	\label{table:simple-evalconfigs}
\end{center}
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{Evaluation of static variable extraction and assignments, and method invocation expressions}
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{Evaluation of instance property extraction and assignment expressions}
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{Evaluation of instance method invocation expressions}
...
\newcommand{\execcesktrans}[4]{\labl{#1}\, &\cesktrans{#2}{#3}\,\hspace{2mm}#4\\[2mm]}
%
