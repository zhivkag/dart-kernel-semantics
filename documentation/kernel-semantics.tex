...
\[
  \begin{array}{lcl@{\hspace{30mm}}}
	...
	\textrm{if }\idmeta \textrm{ is a method with body }\stmt\textrm{ and formals }\formals :\\
	...
	\textrm{if }\idmeta \textrm{ is getter with statement body }\stmt :\\
	\hspace{2mm}\contconf{\propertygetk}{\synval}
	& \Rightarrow &
	...
	\textrm{if }\idmeta \textrm{ is an implicit getter for field }\idmeta :\\
	\hspace{2mm}\contconf{\propertygetk}{\synval}
	& \Rightarrow &
	\contconf{\econt}{\deref(\synval[\idmeta])}\\
  \end{array}
\]
