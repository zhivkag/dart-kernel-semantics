...
\]
\noindent
After the evaluation of the receiver expression to a value $\val$, the instance method $\idmeta$ is looked up in methods for the value $\val$. Let $\membermeta$ be the result of such lookup. Let $\membermeta$ be a method with statement body $\stmt$ and formal parameters $\formals$:
