...
% Exact definition on how the sotre is modified to be added
...
\[
  \begin{array}{lcll}
	...
	& \Rightarrow &
	\contconf{\econt}{\val},
	\hspace{2mm}\val = \mathrm{IntLiteral(\synval)} \in \mathbf{int}\\[2mm]

	\evalconf{\mathrm{DoubleLiteral(\synval)}}{\env}{\strace}{\cstrace}{\cex}{\econt}
	& \Rightarrow &
	\contconf{\econt}{\val},
	\hspace{2mm}\val = \mathrm{DoubleLiteral(\synval)} \in \mathbf{double}\\[2mm]

	\evalconf{\mathrm{BoolLiteral(\synval)}}{\env}{\strace}{\cstrace}{\cex}{\econt}
	& \Rightarrow &
	\contconf{\econt}{\val},
	\hspace{2mm}\val = \mathrm{BoolValue(\synval)} \in \mathbf{bool}\\[2mm]

	\evalconf{\mathrm{StringLiteral(\synval)}}{\env}{\strace}{\cstrace}{\cex}{\econt}
	& \Rightarrow &
	\contconf{\econt}{\val}, 
	\hspace{2mm}\val = \mathrm{StringValue(\synval)} \in \mathbf{String}
...
\[
  \begin{array}{lcl}
	\textbf{f} = \mathrm{FunctionNode}(\formals, \stmt_{body}),\\
