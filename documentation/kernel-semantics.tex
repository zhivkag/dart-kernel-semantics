...
\newcommand{\StaticInvApp}[4]{\mathrm{StaticInvocationA}({#1},\,{#2},\,{#3},\,\ExceptionHandlersRest,\,{#4})}
...
\begin{center}
	...
	\begin{array}{lrclr}
		...
		\evalcesktrans
			...
			{\evalconf{\expr}{\env}{\strace}{\cstrace}{\cex}{\throwk{(\textbf{throw } \expr) :: \strace}{\handler}}}
			{}
...
\begin{center}
	...
	\begin{array}{lrcl}	
		...
		\evalcesktrans
			...
			{\\&&&\acont' = \StaticInvApp{\formals}{\stmt}{\strace'}{\econt}
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{Instance property extraction and assignment}
...
\[
  \begin{array}{rcl}
	\cesktrans{
		\acontconf{\StaticInvApp{\formals}{\stmt}{\strace}{\econt}}{\val{s}}}{
		\execconf{\stmt}{\env'}{[]}{[]}{\handler}{\cstrace}{\cex}{\econt}{\scont}}
	\\[2mm]
	\scont = \ExitSK{\tt{null}},
...
\begin{center}
	...
	\end{array}
	$
	\captionof{table}{Instance method invocation}
	\label{table:instance-method-evalconfigs}
\end{center}
