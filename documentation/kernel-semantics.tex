...
\begin{itemize}
	...
	\item Otherwise, there is only one initializer in the initializer list and it is $\RedirectingInitializer{G}{\expressionsmeta}$ or $\SuperInitializer{G}{\expressionsmeta}$.

		When the initializer is redirecting, i.e. $\RedirectingInitializer{G}{\exprs}$, the transition is as follows:
		\begin{align*}
			\cesktranswheresplit%
			{\acontconf{\FieldsA{Q}{\loc}{\env}{\scont}}{\val{s}}}%
			{\evallistconf{\exprs}{\env}{\strace}{\cstrace}{\cex}{\acont}}%
