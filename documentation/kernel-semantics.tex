...
\begin{align*}
    ...
    \cesktranswheresplit*%
        ...
        $\scont = \NewSK{\econt}{\val}$}}
    \end{multlined}
\end{align*}

We introduce a new statement continuation, $\NewSK{\econt}{\val}$ which captures the expression continuation that will be eventually applied to the newly allocated value after the execution of the statement body of the constructor.

\begin{align}
    &\cesktrans{\scontconf{\NewSK{\econt}{\val}}{\env}}{\contconf{\econt}{\val}}.
\end{align}
