...
Expression continuations with expressions will produce EvalConfiguration for evaluation of the next expression. For example, $\conditionalk{\expri{1}}{\expri{2}}{\env}{\strace}{\cstrace}{\cex}{\econt}$, will proceed to the next configuration depending on the input value and produce an EvalConfiguration for the evaluation of the expression $\expri{1}$ or $\expri{2}$ accordingly.
